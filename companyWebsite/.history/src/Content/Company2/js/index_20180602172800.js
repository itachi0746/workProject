...
$(function() {
  ...
  $(".features div").hover(
    function() {
      ...
      $(this).css({
        'box-shadow':'0px 0px 5px rgba($color: #245d7f, $alpha: 0.85)',
        '-webkit-box-shadow':'0px 0px 5px rgba($color: #245d7f, $alpha: 0.85)',
        '-moz-box-shadow':'0px 0px 5px rgba($color: #245d7f, $alpha: 0.85)',
        '-o-box-shadow':'0px 0px 5px rgba($color: #245d7f, $alpha: 0.85)',
        '-ms-box-shadow':'0px 0px 5px rgba($color: #245d7f, $alpha: 0.85)'
      });
    },
    function() {
