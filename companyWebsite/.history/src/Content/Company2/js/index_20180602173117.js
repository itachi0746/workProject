...
$(function() {
  ...
  $(".features div").hover(
    function() {
      ...
      $(this).css({
        'box-shadow':'0px 0px 10px 10px rgba($color: #245d7f, $alpha: 0)',
        '-webkit-box-shadow':'0px 0px 10px 10px rgba($color: #245d7f, $alpha: 0)',
        '-moz-box-shadow':'0px 0px 10px 10px rgba($color: #245d7f, $alpha: 0)',
        '-o-box-shadow':'0px 0px 10px 10px rgba($color: #245d7f, $alpha: 0)',
        '-ms-box-shadow':'0px 0px 10px 10px rgba($color: #245d7f, $alpha: 0)'
      });
    },
    function() {
