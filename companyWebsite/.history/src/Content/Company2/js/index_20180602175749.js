...
$(function() {
  ...
  $(".features div").hover(
    function() {
      ...
      $(this).css({
        'box-shadow':'0px 0px 10px 0px rgba(178, 187, 190, 0.85)',
        '-webkit-box-shadow':'0px 0px 10px 0px rgba(178, 187, 190, 0.85)',
        '-moz-box-shadow':'0px 0px 10px 0px rgba(178, 187, 190, 0.85)',
        '-o-box-shadow':'0px 0px 10px 0px rgba(178, 187, 190, 0.85)',
        '-ms-box-shadow':'0px 0px 10px 0px rgba(178, 187, 190, 0.85)'
      });
    },
    function() {
  ...
  // 华为云的hover
  $('#huaweiyun .h-item').hover(
    function () {  
      $(this).find('.h-before').addClass('dn');
      $(this).find(".h-after").addClass("dib");
      $(this).find("p").css('color','#f88929');

    },
    function () {  
      $(this).find('.h-before').removeClass('dn');
      $(this).find(".h-after").removeClass("dib");
      $(this).find("p").css('color','#000');

    }
  );
  // 我们的产品的hover
  $('#OurProducts .op-box').hover(
    function () {  
      $(this).find('.op-before').addClass('dn');
      $(this).find(".op-after").addClass("dib");
      $(this).find("h4").css('color','#f88929');
      $(this).css({
        'box-shadow':'0px 0px 10px rgba(74,132,166,0.85)',
        '-webkit-box-shadow':'0px 0px 10px 0px rgba(178, 187, 190, 0.85)',
        '-moz-box-shadow':'0px 0px 10px 0px rgba(178, 187, 190, 0.85)',
        '-o-box-shadow':'0px 0px 10px 0px rgba(178, 187, 190, 0.85)',
        '-ms-box-shadow':'0px 0px 10px 0px rgba(178, 187, 190, 0.85)',
    ...
    function () { 
      $(this).find('.op-before').removeClass('dn');
      $(this).find(".op-after").removeClass("dib");
      $(this).find("h4").css('color','#7c7c7c');
      $(this).css({
        'box-shadow':'none',
        '-webkit-box-shadow':'none',
