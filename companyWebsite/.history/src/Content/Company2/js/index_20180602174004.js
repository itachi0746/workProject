...
$(function() {
  ...
  $(".features div").hover(
    function() {
      ...
      $(this).css({
        'box-shadow':'0px 0px 10px 10px rgba(74,132,166,0.85)',
        '-webkit-box-shadow':'0px 0px 10px 10px rgba(74,132,166,0.85)',
        '-moz-box-shadow':'0px 0px 10px 10px rgba(74,132,166,0.85)',
        '-o-box-shadow':'0px 0px 10px 10px rgba(74,132,166,0.85)',
        '-ms-box-shadow':'0px 0px 10px 10px rgba(74,132,166,0.85)'
      });
    },
    function() {
